...
echo Got it - !RETURN_CHOICE! - !TANK_SERIES[!!RETURN_CHOICE!!]!
if %errorlevel% GTR 0 (
	ver > nul
...
echo Got it - !RETURN_CHOICE! - !TANK_MODEL[!!RETURN_CHOICE!!]!
if %errorlevel% GTR 0 (
	ver > nul
...
echo.
REM only present the next choice if there is a previous level in %4
REM echo Previous: %4
if NOT [%4]==[] (
